...
/**
 * {@link CodeNodeItemContainer} containing {@link CodeReadableItemWithName#getName() named} {@link CodeItem}s.
 *
...
public abstract interface CodeNodeItemContainerWithName<I extends CodeItem> extends CodeNodeItemContainer<I> {
  ...
  /**
   * @param name the {@link CodeReadableItemWithName#getName() name} of the requested {@link CodeItem}.
  ...
  /**
   * @param name the {@link CodeReadableItemWithName#getName() name} of the {@link CodeReadableItemWithName} to create.
  ...
  @Override
  CodeNodeItemContainerWithName<I> getImmutable();
