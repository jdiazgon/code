 ...
 * @since 1.0.0
 */
public interface CodeReadableSuperTypes<T extends CodeGenericType> extends CodeNodeItemContainerHierarchical<T> {
  ...
  @Override
  CodeReadableSuperTypes<T> getImmutable();

  @Override
  CodeReadableSuperTypes<T> copy();
